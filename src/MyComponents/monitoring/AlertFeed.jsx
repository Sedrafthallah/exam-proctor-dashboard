import { theme, Flex, Badge, Avatar, List, Image } from "antd";
import {
  BellOutlined,
  CheckOutlined,
  ...
  return (
    ...
    >
      <List
        ...
        renderItem={(alert) => {
          const config =
            ALERT_TYPE_CONFIG[alert.type] ?? DEFAULT_ALERT_TYPE_CONFIG;
          const statusConfig =
            ALERT_STATUS_CONFIG[alert.status] ?? ALERT_STATUS_CONFIG.OPEN;
