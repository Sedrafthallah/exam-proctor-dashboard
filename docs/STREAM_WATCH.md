...
7. Click **Watch** → modal should show video within a few seconds on LAN.
8. **End watch** → Flutter “Proctor viewing” clears; a second Watch should succeed.
...
| `src/store/useMonitoringHubStore.js` | Presence + watch PC lifecycle |
...
| `WatchStreamModal.jsx` | Viewer UI |
